...
async function drawLink(url) {
  ...
  for (i = 0; i <= urlLen; i++) {
    ...
    result.innerHTML = '<h3 class="linkResult" data-clipboard-text="eeZee.link/' + url + '" style="cursor:pointer">eeZee.link/' + urlSub + '<small><small id="copyText"> - click to copy</small></small></h3><small>link expires 6 months after last use</small>' }
    await sleep(40)
  } 
